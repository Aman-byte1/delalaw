                    ...
                    <div class="descript_wrap white-bg">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('account.port', $application->user_id)}}">{{ $application->user->name  }}'s</a></td>
                                <td>
...
<p id="your_not_an_employee" >Invalid user type. You cannot apply for jobs as a {{ Auth::user()->user_type }}</p>

@else (Auth::user()->user_type != 'employee')
