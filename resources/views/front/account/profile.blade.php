                ...
                <div class="card border-0 shadow mb-4">
                    <form action="" method="post" id="userForm" name="userForm">
                        <div class="card-body  p-4">
                            <h3 class="fs-4 mb-1">{{$user->name}}'s Profile</h3>
                            <div class="mb-4">
                            ...
                            <div class="card-body p-4">
                                <h3 class="fs-4 mb-1">Portfolio</h3>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Education*</label>
                                    <input type="text" name="Education" id="Education" placeholder="Education" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">description*</label>
                                    <textarea name="description" id="description" placeholder="describe yourself" class="form-control"></textarea>
                                    <p></p>
                                </div>
                            </div>
                            @endif
...
<script type="text/javascript">
    ...
    $("#changeportfolio").submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: $("#changeportfolio").serializeArray(),
            success: function(response) {
                ...
                if (response.status == true) {
                    ...
                    window.location.href = "{{ route('portfolio.store') }}";
